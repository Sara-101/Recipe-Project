...
function getRecommendedRecipes(dietaryRestrictions, spiceLevel, allergies, mealType) {
    // Example recipes (replace this with actual recipes and logic for filtering)
     const allRecipes = [
        ...
        { name: "Butter Chicken ", url: "https://www.allrecipes.com/recipe/141169/easy-indian-butter-chicken/", dietary: "None", spice: "Spicy", allergens: "Dairy", type: "Dinner" },
        { name: "Green Goddess Salad", url: "https://feelgoodfoodie.net/recipe/green-goddess-salad/", dietary: "Vegan", spice: "Mild", allergens: "None", type: "Lunch" },
        { name: "Birria Tacos", url: "https://www.dinneratthezoo.com/grilled-salmon/", dietary: "None", spice: "Mild", allergens: "None", type: "Lunch" },
        { name: "Gluten-Free Pancakes", url: "https://www.gimmesomeoven.com/sizzlin-spicy-szechuan-stir-fry/", dietary: "Vegan", spice: "Spicy", allergens: "None", type: "Dinner" },
        { name: "Cajun Shrimp Pasta", url: "https://www.thekitchn.com/cajun-shrimp-pasta-recipe-23449288", dietary: "None", spice: "Medium", allergens: "Shellfish", type: "Dinner" },
